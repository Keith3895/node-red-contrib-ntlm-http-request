...
module.exports = function (RED) {
    ...
    function HTTPRequest(n) {
        ...
        this.on("input", function (msg) {
            let ntlmPassword = msg.ntlmPassword || n.ntlmPassword;
            let ntlmUsername = msg.ntlmUsername || n.ntlmUsername;
            let ntlmDomain = msg.ntlmDomain || n.ntlmDomain;
            let ntlmWorkstation = msg.ntlmWorkstation || n.ntlmWorkstation;
            ...
            opts = Object.assign(opts, ntlmOptions);


            function generic(err, res) {
                if (err) {
            ...
            switch (opts.method) {
                case 'GET':
                    request.get(opts, opts.body, generic);
                    break;
                case 'POST':
                    node.warn(typeof opts.body);
                    request.post(opts, opts.body, generic);
                    break;
                case "PUT":
                    request.put(opts.opts.body, generic);
                    break;
                case "PATCH":
                    request.patch(opts.opts.body, generic);
                    break;
                case "DELETE":
                    request.delete(opts.opts.body, generic);
                    break;
            }
    ...
    RED.nodes.registerType("ntlm http request", HTTPRequest, {
        credentials: {
            user: { type: "text" },
